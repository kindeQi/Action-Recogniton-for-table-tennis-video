...
if __name__ == "__main__":
    ...
    data = sorted(
        data,
        key=lambda x: int(x["info"]["path"].split("/")[-1]) * 1000000
        + int(x["info"]["start_time"]),
    )
    ...
    for video_index in range(a, b):
        ...
        bash_command = 'ffmpeg -framerate 8 -start_number {} -i "/home/zhangrui/demo/%d.png" /home/zhangrui/demo/{}.mp4'.format(
            item["info"]["start_time"], video_index
        )
